[![Travis build status shield](https://img.shields.io/travis/moriokatky/mycozyapp/master.svg)](https://travis-ci.org/moriokatky/mycozyapp)
[![Github Release version shield](https://img.shields.io/github/tag/moriokatky/mycozyapp.svg)](https://github.com/moriokatky/mycozyapp/releases)
...
```sh
$ git clone https://github.com/moriokatky/mycozyapp.git
$ cd mycozyapp
$ yarn install
```
...
After the build and the stack launched, your app is now available at http://mycozyapp.cozy.tools:8080.
...
The lead maintainer for Mycozyapp is [moriokatky](https://github.com/moriokatky), send him/her a :beers: to say hello!
...
Mycozyapp is developed by moriokatky and distributed under the [AGPL v3 license][agpl-3.0].
